...
const ANC_BRAVO = "bravo"

var SOUNDS = {
	PLAYER_SOUND_HURT : preload("res://assets/sound/player/player_damage_crack_level4.wav"),
...
var ANNOUNCER = {
	...
	ANC_BRAVO : preload("res://assets/sound/announcer/announcer_0002_d.wav")
}
